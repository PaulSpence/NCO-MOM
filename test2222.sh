...
ncra -v pot_rho_2,wt -d yt_ocean,0,299 /g/data1/v45/APE-MOM/gfdl_nyf_1080_UP/output${sim}/ocean__*.nc /short/v45/pas561/mom/archive/up.wtrho2.${sim}.yt300.ncra.nc
